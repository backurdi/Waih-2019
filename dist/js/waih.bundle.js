(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["waih"],{
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Podcast = function () {\n    function Podcast() {\n        _classCallCheck(this, Podcast);\n    }\n\n    _createClass(Podcast, [{\n        key: 'get',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {\n                var podcastResults;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.prev = 0;\n\n                                console.log(id);\n                                id = id ? '?id=' + id : '';\n                                console.log(id);\n                                _context.next = 6;\n                                return (0, _axios2.default)('http://waih.dk/WaihAPI/podcast/get/' + id);\n\n                            case 6:\n                                podcastResults = _context.sent;\n\n                                this.results = podcastResults.data.podcasts;\n                                _context.next = 13;\n                                break;\n\n                            case 10:\n                                _context.prev = 10;\n                                _context.t0 = _context['catch'](0);\n\n                                alert(_context.t0);\n\n                            case 13:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[0, 10]]);\n            }));\n\n            function get(_x) {\n                return _ref.apply(this, arguments);\n            }\n\n            return get;\n        }()\n    }, {\n        key: 'delete',\n        value: function () {\n            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id) {\n                var podcastResults;\n                return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                    while (1) {\n                        switch (_context2.prev = _context2.next) {\n                            case 0:\n                                _context2.prev = 0;\n\n                                id = id ? '?id=' + id : '';\n                                _context2.next = 4;\n                                return (0, _axios2.default)('http://waih.dk/WaihAPI/podcast/delete/' + id);\n\n                            case 4:\n                                podcastResults = _context2.sent;\n\n                                this.results = podcastResults.data.podcasts;\n                                _context2.next = 11;\n                                break;\n\n                            case 8:\n                                _context2.prev = 8;\n                                _context2.t0 = _context2['catch'](0);\n\n                                alert(_context2.t0);\n\n                            case 11:\n                            case 'end':\n                                return _context2.stop();\n                        }\n                    }\n                }, _callee2, this, [[0, 8]]);\n            }));\n\n            function _delete(_x2) {\n                return _ref2.apply(this, arguments);\n            }\n\n            return _delete;\n        }()\n    }, {\n        key: 'update',\n        value: function () {\n            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(id, param, newValue) {\n                var query, podcastResults;\n                return regeneratorRuntime.wrap(function _callee3$(_context3) {\n                    while (1) {\n                        switch (_context3.prev = _context3.next) {\n                            case 0:\n                                _context3.prev = 0;\n                                query = '?id=' + id + '&param=' + param + '&newValue=' + newValue;\n                                _context3.next = 4;\n                                return (0, _axios2.default)('http://waih.dk/WaihAPI/podcast/update/' + query);\n\n                            case 4:\n                                podcastResults = _context3.sent;\n\n                                this.results = podcastResults.data.podcasts;\n                                _context3.next = 11;\n                                break;\n\n                            case 8:\n                                _context3.prev = 8;\n                                _context3.t0 = _context3['catch'](0);\n\n                                alert(_context3.t0);\n\n                            case 11:\n                            case 'end':\n                                return _context3.stop();\n                        }\n                    }\n                }, _callee3, this, [[0, 8]]);\n            }));\n\n            function update(_x3, _x4, _x5) {\n                return _ref3.apply(this, arguments);\n            }\n\n            return update;\n        }()\n    }]);\n\n    return Podcast;\n}();\n\nexports.default = Podcast;\n\n//# sourceURL=webpack:///./src/js/model/podcast.js?");
